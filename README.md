...
Jessyink is a build in extension of [inkscape](https://inkscape.org). It allows to create pan and zoom presentations like [this example]([https://./files/JessyInkDemo.svg](https://tshoppa.github.io/jessyink-cutroom/files/JessyInkDemo.svg)) (please use arrows left and right to navigate, mouse navigation was disabled to enable links).
